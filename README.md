# pyBot
**nonActivitiesHelpers.py** — удаление неактивных более N дней помощников новичков<br>
**checkLinksThere.py** — проверка корректност установки номинационных шаблонов<br>
**trashCheck.py** — мониторинг свежих правок на предмет наличие в них феминитивных слов-уродов, таких как «авторка»<br><br>
