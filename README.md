# pyBot
** nonActivitiesHelpers.py - удаление неактивных более N дней помощников новичков**
** checkLinksThere.py - проверка корректност установки номинационных шаблонов**
** trashCheck.py - мониторинг свежих правок на предмет наличие в них феминитивных слов-уродов, таких как «авторка»**
