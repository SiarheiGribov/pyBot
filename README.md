...
**4. huggle_vers** — обновление шаблона с версией Huggle<br>
**5. level_vand** — обновление уровня в шаблоне «уровень вандализма»<br>
**6. login.py** — служебный скрипт для логина<br>
