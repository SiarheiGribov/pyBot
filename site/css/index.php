...
echo "
<div align='left'>
<a href='' id='admin-soursec'>Очистить таблицу источников</a>
<a href='' id='admin-fem'>Очистить таблицу феминитивов</a>
<a href='' id='admin-soursec7'>Удалить из таблицы сомнительных источников записи старше 7 дней</a>
<a href='' id='admin-fem7'>Удалить из таблицы феминитивов источников записи старше 7 дней</a>
</div>	 
	 <script>
         jQuery(document).ready(function() {
